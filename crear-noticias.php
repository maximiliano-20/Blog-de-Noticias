        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                  <h2 class="text-white">Crear una Noticia</h2>
                </div>
                
                <div class="login-form">

                    <?php if (isset($_SESSION['errores']['general'])): ?>
                        <div class="alert alert-danger text-center"><?=$_SESSION['errores']['general']?></div>
                    <?php endif ?>
                 

               
                    <form action="agregar-noticias.php" method="POST">
             ...
             <!-- Mostramos los errores de validacion -->  
                            <div class="form-group">
                              ...
                              <textarea placeholder="Contenido" class="form-control" name="contenido"></textarea>
                        </div>
                         <!-- Mostramos los errores de validacion -->  

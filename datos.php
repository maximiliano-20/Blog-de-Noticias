        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <h2 class="text-white">Mis Datos</h2>
             ...
             <!-- Mostramos los errores de validacion --> 
                        ...
                        <input type="text" class="form-control"  name="apellido" value="<?=$_SESSION['usuario']['apellido']?>">
                         </div>
                <!-- Mostramos los errores de validacion -->  
                   ...
                   <!-- Mostramos los errores de validacion --> 
                     ...
                     <button class="btn btn-info btn-flat m-b-30 m-t-30">Actualizar Usuario</button>
